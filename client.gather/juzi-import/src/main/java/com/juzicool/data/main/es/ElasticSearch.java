package com.juzicool.data.main.es;
...
public class ElasticSearch {
	...
	private  RestClientBuilder mBuilder;

	public ElasticSearch(String host,int port,String name,String password,int timeOut){
		mBuilder = createRestClientBuilder(host,port,name,password,timeOut);
	}
	
	private static RestClientBuilder createRestClientBuilder(String host,int port,String name,String password,final int timeout) {
