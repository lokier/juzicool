...
public class SimhashAlgoService {
    ...
    public static void main(String[] args) {
        ...
        String string1 = "不为遇见，只为远方";
        String string2 = "不为遇见5，只为远方";
        String string3 = "不为遇见，只为远方4";

        string1 = "我没有李太白手执一笔青锋抒尽心中万缕情丝的豪迈 \n" +
                "只有一支忙碌于黑夜从不停歇的孤单画笔 \n" +
                "摘下那妙手偶得之的灵感和一丝悸动 \n" +
                "留下生活中的那点点滴滴和唯美！";

        string2 = "我没有李太白手执一笔青锋抒尽心中万缕情丝的豪迈 \n" +
                "只有一支忙碌于黑夜从不停歇的孤单画笔 \n" +
                "摘下那妙手偶得之的灵为感和一丝悸动 \n" +
                "留下生活中的那点点滴滴和唯美！";

        string3 = "我没有李太白手执一笔青锋抒尽心中万缕情丝的豪迈 \n" +
                "只有一支忙碌于黑夜从不停歇的孤单画笔 \n" +
                "摘下那妙手偶得之的灵感和一丝悸动 \n" +
                "留下生活中的那点点滴滴和唯美！";


        List<String> fingerPrints = simhashAlgoService.simHash(string1,8);
        System.out.println(fingerPrints);

        fingerPrints = simhashAlgoService.simHash(string2,8);
        System.out.println(fingerPrints);

        fingerPrints = simhashAlgoService.simHash(string3,8);
        System.out.println(fingerPrints);

        System.out.println(HanLP.segment("你好，欢迎使用我们的HanLP汉语处理包！"));
